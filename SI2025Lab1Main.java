...
class TaskManager {
    ...
    tasks.removeIf(task -> task.getName().equalsIgnoreCase(name));        // TODO: Implement removal logic
    }
   ...
   tasks.stream().sorted(Comparator.comparing(Task::getPriority).reversed()).forEach(System.out::println);        // TODO: Implement sorting by priority logic
    }
